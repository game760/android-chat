...
public class Config {
     ...
     * <br>
     */
    public static String IM_SERVER_HOST = "openim.queryip.top";
     ...
     */
    public static String WORKSPACE_URL = "https://user.queryip.top/workgroup.html";
     ...
     * 请注意，不能写应用服务地址
     */
    public static String ORG_SERVER_ADDRESS = "https://org.wildfirechat.cn";
